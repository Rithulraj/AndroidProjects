...
EditText tvUN,tvPW;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tvUN=(EditText)findViewById(R.id.un);
        tvPW=(EditText)findViewById(R.id.pw);

        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                username = tvUN.getText().toString();
                password=tvPW.getText().toString();

                new Login.SendRequest().execute();
            }
    ...
    public class SendRequest extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... arg0) {
            ...
            try{
               ...
               // String id="1-K-Z7bdJ5dHBjnHEfXju6Xmyp8vfarWRJwPegvZtvoM";
